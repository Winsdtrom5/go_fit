  ...
  export default {
    ...
    methods: {
      ...
      saveupdate() {
        ...
        axios.put(`https://gofit123.xyz/Server_Go_Fit/public/member/${this.formTodo.id_member}/editdata`, {
        ...
        .then(response => {
            ...
            console.log("Link", `https://gofit123.xyz/Server_Go_Fit/public/member/${this.formTodo.id_member}`);
      ...
      deleteConfirmed() {
        axios.delete('https://gofit123.xyz/Server_Go_Fit/public/member/' + this.itemToDelete.id_member)
          .then(response => {
            console.log(response.data);
            this.getTrainee();
      ...
      checkExpirationDate() {
        ...
        this.filteredTodos.forEach(item => {
          ...
          axios.put(`https://gofit123.xyz/Server_Go_Fit/public/member/${item.id_member}`, {
      ...
      resetItem(item){
        axios
          .put(`https://gofit123.xyz/Server_Go_Fit/public/member/${item.id_member}`, {
              nama_member: item.nama_member,
      ...
      deleteItem(item) {
        // axios.delete(`https://gofit123.xyz/Server_Go_Fit/public/member/${item.id_member}`)
        // window.location.reload();
